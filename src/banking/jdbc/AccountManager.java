...
public class AccountManager {
	...
	public void makeAccount() {
		...
		String mkAccount, mkName;
		int mkMoney, mkInterest;
		
		System.out.print("계좌번호:"); 
		mkAccount = BankingSystemMain.scan.nextLine();
		
		System.out.print("고객이름:"); 
		mkName = BankingSystemMain.scan.nextLine();
		
		System.out.print("잔고:"); 
		mkMoney = BankingSystemMain.scan.nextInt();
		
		System.out.print("기본이자%(정수형태로입력):"); 
		mkInterest = BankingSystemMain.scan.nextInt();
		
		BankingSystemMain.scan.nextLine();
		
		Account acc = new Account(mkAccount, mkName, mkMoney, mkInterest);
		...
		if(myAccount.contains(acc)) {
			...
			if(same.toUpperCase().equals("Y")) {
				...
				InsertBanking insert = new InsertBanking();
				insert.insertAccount(acc);
			} else {
